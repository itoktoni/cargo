...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'marketing_category_id') ? 'has-error' : ''}}">
        {{ Form::select($form.'marketing_category_id', $categories, null, ['class'=> 'form-control']) }}
        {!! $errors->first($form.'marketing_category_id', '<p class="help-block">:message</p>') !!}
    </div>
