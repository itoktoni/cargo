...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'inventory_warehouse_id') ? 'has-error' : ''}}">
        {{ Form::select($form.'inventory_warehouse_id', $warehouse, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
        {!! $errors->first($form.'inventory_warehouse_id', '<p class="help-block">:message</p>') !!}
    </div>
