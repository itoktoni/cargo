...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has($form.'inventory_branch_id') ? 'has-error' : ''}}">
        {{ Form::select($form.'inventory_branch_id', $branches, null, ['class'=> 'form-control', 'data-plugin-selectTwo']) }}
        {!! $errors->first($form.'inventory_branch_id', '<p class="help-block">:message</p>') !!}
    </div>
