...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia_svelte__ = __webpack_require__(39);


var app = document.getElementById('app');

new __WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia_svelte__["a" /* InertiaApp */]({
  target: app,
  props: {
    initialPage: JSON.parse(app.dataset.page),
    resolveComponent: function resolveComponent(name) {
      return !(function webpackMissingModule() { var e = new Error("Cannot find module \"./Pages\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).default;
    }
  }
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return writable; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__internal__ = __webpack_require__(38);
 ...
 * @param {StartStopNotifier=}start start and stop notifications for subscriptions
 */
function writable(value, start = __WEBPACK_IMPORTED_MODULE_0__internal__["b" /* noop */]) {
    let stop;
    const subscribers = [];
    function set(new_value) {
        if (Object(__WEBPACK_IMPORTED_MODULE_0__internal__["e" /* safe_not_equal */])(value, new_value)) {
            value = new_value;
    ...
    function subscribe(run, invalidate = __WEBPACK_IMPORTED_MODULE_0__internal__["b" /* noop */]) {
        const subscriber = [run, invalidate];
        subscribers.push(subscriber);
        if (subscribers.length === 1) {
            stop = start(set) || __WEBPACK_IMPORTED_MODULE_0__internal__["b" /* noop */];
        }
        run(value);
        return () => {
...
function derived(stores, fn, initial_value) {
    ...
    return readable(initial_value, (set) => {
        ...
        const values = [];
        let pending = 0;
        let cleanup = __WEBPACK_IMPORTED_MODULE_0__internal__["b" /* noop */];
        const sync = () => {
            if (pending) {
                return;
            }
            ...
            if (auto) {
                ...
                cleanup = Object(__WEBPACK_IMPORTED_MODULE_0__internal__["a" /* is_function */])(result) ? result : __WEBPACK_IMPORTED_MODULE_0__internal__["b" /* noop */];
            }
        };
        const unsubscribers = stores_array.map((store, i) => Object(__WEBPACK_IMPORTED_MODULE_0__internal__["f" /* subscribe */])(store, (value) => {
            values[i] = value;
            pending &= ~(1 << i);
            if (inited) {
                sync();
        ...
        return function stop() {
            Object(__WEBPACK_IMPORTED_MODULE_0__internal__["d" /* run_all */])(unsubscribers);
            cleanup();
        };
    });
}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return is_function; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return onDestroy; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return run_all; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return safe_not_equal; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return subscribe; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__App_svelte__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__App_svelte___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__App_svelte__);
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_0__App_svelte__, "default")) __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__App_svelte__["default"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Link_svelte__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Link_svelte___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Link_svelte__);
/* unused harmony reexport InertiaLink */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__page__ = __webpack_require__(42);
/* unused harmony reexport page */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__remember__ = __webpack_require__(44);
/* unused harmony reexport remember */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_svelte_store__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store__ = __webpack_require__(43);



const page = Object(__WEBPACK_IMPORTED_MODULE_0_svelte_store__["a" /* derived */])(__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */], $store => $store.props)
...
const store = Object(__WEBPACK_IMPORTED_MODULE_0_svelte_store__["b" /* writable */])({
  component: null,
  key: null,
  props: {},
})
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_svelte__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_svelte_store__ = __webpack_require__(37);




function remember(initialState, key) {
  const restored = __WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia__["Inertia"].restore(key)
  const store = Object(__WEBPACK_IMPORTED_MODULE_2_svelte_store__["b" /* writable */])(restored !== undefined ? restored : initialState)
  const unsubscribe = store.subscribe(state => __WEBPACK_IMPORTED_MODULE_0__inertiajs_inertia__["Inertia"].remember(state, key))

  Object(__WEBPACK_IMPORTED_MODULE_1_svelte__["a" /* onDestroy */])(unsubscribe)

  return store
}

/* unused harmony default export */ var _unused_webpack_default_export = (remember);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__internal__["c"]; });
